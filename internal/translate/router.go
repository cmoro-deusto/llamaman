...
//
//	<bin> --models-preset <file> --host <host> --port <port>
//
...
//
// The registry is consulted for canonical flag forms; if the running
// llama-server lacks --models-preset entirely, callers should surface a
// version-gate error before reaching Spawn (see main.go).
